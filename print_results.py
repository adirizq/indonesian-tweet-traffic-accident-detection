...
for architecture in tqdm(architectures):
    ...
    for hyper_param in hyper_params:
        ...
        data['accuracy'].append(round(test['test_accuracy'].values[0], 2))
        data['f1'].append(round(test['test_f1_score'].values[0], 2))
        data['precision'].append(round(test['test_precision'].values[0], 2))
        data['recall'].append(round(test['test_recall'].values[0], 2))
